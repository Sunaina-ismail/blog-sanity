      ...
      <div className="bg-[#e6d2c9] items-center justify-center w-full ">
        <div className="container mx-auto flex justify-between items-center px-2 md:px-8 py-4 md:py-5">
          <div className="flex items-center space-x-1">
           ...
           <Link href={'/'}> <h1 className="text-lg sm:text-xl md:text-2xl font-serif font-medium md:font-semibold text-gray-800">
            Face The Future
            </h1>
            </Link>
          </div>
          ...
          <nav>
            <ul className="hidden md:flex space-x-6  text-gray-800 font-medium">
              ...
              <li>
                <Link href="/" className="hover:border-b-red-950 hover:border-b-2">
               SkinCare
                </Link>
              </li>
              <li>
        ...
        {menuOpen && (
          <div className="absolute top-16 left-0 w-full bg-white  shadow-lg md:hidden z-50">
            ...
            <Link href="/" className="hover:bg-[#e6d2c9] px-4 py-3 rounded-md">
               SkinCare
                </Link>
